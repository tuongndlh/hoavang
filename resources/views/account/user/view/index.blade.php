					...
					<div class="panel panel-flat">
						...
						<div class="form-group row">
							<label class="col-lg-2 ">Tên thành viên :</label>
								...
								<div class="col-lg-10 ">{!! isset($data_user) ? $data_user['fullname'] : null  !!}

								</div>

							<input type="hidden" id="user_id" value="{!! isset($data_user) ? $data_user['id'] : null  !!}">
						</div>
						...
						<div class="form-group row">
							<label class="col-lg-2">Tên đăng nhập :</label>
								...
								<div class="col-lg-10 ">
									{!! isset($data_user) ? $data_user['username'] : null  !!}
								</div>
						...
						<div class="form-group row">
							<label class="col-lg-2 ">Emai :</label>
								...
								<div class="col-lg-10 ">
									{!! isset($data_user) ? $data_user['email'] : null  !!}
								</div>
							...
							<label class="col-lg-2 ">Di động :</label>
								...
								<div class="col-lg-10 ">
									{!! isset($data_user) ? $data_user['mobile'] : null  !!}
								</div>
					...
					<div class="content-header">
		             <div class="panel panel-flat">
		               <ol class="panel-heading">
		                 <div >
		                   <a class="pull-right" href="{{ route('View_Add_Detail',$data_user['id']) }}" ><span class="btn btn-primary"><i class="fa fa-plus-circle fa-fw fa-lg"></i> Thêm thành viên</span> </a>
     		...
     		$(document).ready(function() {
     			$(function() {
	               ...
	               $('#table').DataTable({
	               	...
	               	ajax:
	               	({
	               	url: "{{ url('getlist_user_manager',['id'=>$data_user->id]) }}",
	               	}),
