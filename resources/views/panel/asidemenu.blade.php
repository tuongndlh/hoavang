        ...
        <div class="tab-pane active" id="timeline" role="tabpanel">
          ...
          <div class="callout callout-warning m-0 py-3">
            <div class="avatar float-right">
              <img src="{{ asset('public/img/avatars/7.jpg') }}" class="img-avatar" alt="admin@bootstrapmaster.com">
            </div>
            <div>Meeting with
              <strong>Lucas</strong>
            </div>
          ...
          <div class="callout callout-primary m-0 py-3">
            ...
            <div class="avatars-stack mt-2">
              ...
              <div class="avatar avatar-xs">
                <img src="{{ asset('public/img/avatars/8.jpg') }}" class="img-avatar" alt="admin@bootstrapmaster.com">
              </div>
            </div>
          </div>
          <hr class="mx-3 my-0">
