    ...
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        <ol class="breadcrumb">
         ...
         <li class="breadcrumb-item active" href="{{route('class')}}">Danh sách lớp</li>
       </ol>
        ...
        <div class="form-group row">
                 <label class="control-label col-sm-3">Học phí<span class="text-danger">*</span></label>
                   ...
                   <select class="select form-control"   data-width="100%"
                     ...
                     <option ></option>
                     @foreach ($cost as $group_item)
                      @if ($group_item->id == old('dept'))
                          <option value="{{ $group_item->id}}" selected=selected >{{ $group_item->name}}
                          - {{ $group_item->price}}</option>
                        @else
                          <option value="{{ $group_item->id}}">{{ $group_item->name}} - {{ $group_item->price}}
                          </option>
                        @endif
