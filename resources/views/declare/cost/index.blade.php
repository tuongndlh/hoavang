    ...
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        <ol class="breadcrumb">
         ...
         <li class="breadcrumb-item active" href="{{route('cost')}}">Danh sách loại học phí</li>
       </ol>
...
<div id="group_customer" class="modal fade" role="dialog"  data-backdrop="false">
    <div class="modal-dialog">
      ...
      <div class="form-group row">
        ...
        <div class="form-group row">
          <label class="control-label col-sm-2">Hoàn trả</label>
          <div class="col-sm-2">
            <input type="hidden" name="rollback" value="0">
            <input type="checkbox" name="rollback" id="rollback" value="1" >
          </div>
          <label class="control-label col-sm-2">Là học phí</label>
          <div class="col-sm-2">
            <input type="hidden" name="is_cost" value="0">
            <input type="checkbox" name="is_cost" id="is_cost" value="1" >
          </div>
          <label class="control-label col-sm-2">Phí khác</label>
          <div class="col-sm-2">
            <input type="hidden" name="other" value="0">
            <input type="checkbox" name="other" id="other" value="1" >
          </div>
        </div>
        <div class="form-group row" id="date_apply_all">
          <label class="control-label col-sm-3">Ngày áp dụng <span class="text-danger"></span></label>
          <div class="col-sm-9">
            <input type="text" class="form-control"  type="number" name="date_apply" id="date_apply" placeholder="Nhập ngày áp dụng" value="">
          </div>
        </div>
        <div class="form-group row">
                        ...
                        success:function(data)
                        {
                          ...
                          //  $('#is_cost').val(data[0].is_cost);
                            ...
                            if(data[0].other == 1){
                                    ...
                                    $('#date_apply_all').show();
                                    $('#date_apply').val(data[0].date_apply);
                                }else{  $("#other").prop("checked", false);}
