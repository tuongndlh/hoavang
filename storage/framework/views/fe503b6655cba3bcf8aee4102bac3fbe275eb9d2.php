<header class="app-header navbar">
  ...
  <a class="navbar-brand" href="/Bizapp"></a>
  <button class="sidebar-minimizer navbar-toggler d-md-down-none" type="button">
    <span class="navbar-toggler-icon"></span>
  </button>
  ...
  <ul class="nav navbar-nav d-md-down-none">
    ...
    <li class="nav-item px-3">
      <a class="nav-link" href="/sample/dashboard"></a>
    </li>
  </ul>
    ...
    <li class="nav-item dropdown">
      <a class="nav-link dropdown-toggle nav-link" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
        <?php if(Auth::check()): ?>
          ...
          <img src="<?php echo e(asset('public/img/avatars/5.jpg')); ?>" class="img-avatar" alt="<?php echo e(Auth::user()->email); ?>">
        <?php else: ?>
