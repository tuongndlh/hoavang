...
<head>
    ...
    <section class="content">
      ...
      <div class="modal-dialog modal-lg">
        ...
        <form method="POST" id="group_customer_form" action="<?php echo e(route('user.store')); ?>" autocomplete="off" >
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-8">
              ...
              value="<?php echo 'LHMT'.str_pad( DB::table('users')->count('*')+1, 4, "0", STR_PAD_LEFT);; ?>">
            </div>
          </div>
          <div class="form-group row">
          ...
          <div class="form-group row">
                <label class="control-label col-sm-4">Bộ phận <span class="text-danger">*</span></label>
                  ...
                  <select class="select form-control"  required="required" data-width="100%"
                    ...
                    <option ></option>
                    <?php $__currentLoopData = $dept; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group_item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          ...
          <div class="form-group row <?php echo e($errors->has('birthday') ? ' has-error' : ''); ?>">
									...
									<div class="col-lg-3 float-right">
										<div class="input-group">
											...
											<input type="text"  required="required" placeholder="Nhập ngày sinh"
												class="form-control" name="birthday" id="birthday" value="<?php echo e(old('to_date')); ?>">
      										<?php if($errors->has('birthday')): ?>
                              <span class="help-block">
                                  <strong class="alert alert-danger"><?php echo e($errors->first('birthday')); ?></strong>
                              </span>
      		                <?php endif; ?>
										</div>
									</div>
            ...
            <div class="col-sm-8">
              <select class="select form-control" data-width="100%" name="manager_assign" id="manager_assign"
               data-placeholder="Chọn người quản lý">
                <option ></option>
                <?php $__currentLoopData = $manager_assign; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group_item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($group_item->id); ?>"><?php echo e($group_item->fullname); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </select>
            </div>
          </div>
              ...
              // Them du lieu
                 $('#group_customer_form').on('submit', function(event){
                  ...
                  $(document).on('click', '.edit', function(){
                      ...
                      //$('#form_output').html('');
                      $.ajax({
                          url:"<?php echo e(route('user.edit',"id")); ?>",
                          method:'GET',
